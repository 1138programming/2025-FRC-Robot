...
public class Swerve extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public static synchronized Swerve get() {
        if (m_CommandSwerveDrivetrain == null) {
            m_CommandSwerveDrivetrain = frc.robot.TunerConstants.createDrivetrain();
        }
    ...
    public void Drive(ChassisSpeeds c) {
        setControl(rrDriveReq.withSpeeds(c));
    }

    public void Drive(ChassisSpeeds c, boolean fieldRelative) {
        if (fieldRelative) {
            this.setControl(frDriveReq.withVelocityX(c.vxMetersPerSecond).withVelocityY(c.vyMetersPerSecond)
